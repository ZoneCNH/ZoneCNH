...
| FR-005      | RateLimiter    | AC-006              | -              | ⬜     |
| FR-006      | Fallback       | AC-007              | -              | ⬜     |
...
| FR-004      | Exporter             | DoD: 所有 FR 有测试    | -         | ⬜     |
| FR-005      | Redaction            | DoD: redaction leak check | -         | ⬜     |
| FR-006      | Label Policy         | DoD: label policy check | TC-002    | ⬜     |
| FR-007      | Health               | DoD: 所有 FR 有测试    | -         | ⬜     |
| BR-001      | Logger 并发安全      | -                      | -race test | ⬜     |
| BR-005      | With 不变性          | -                      | TC-001    | ⬜     |
| BR-006      | 指标命名规范         | DoD: metrics contract check | -         | ⬜     |
| BR-007      | 日志 secret 脱敏     | DoD: redaction leak check | -         | ⬜     |
...
| FR-005      | Cancel                 | DoD: 所有 FR 有测试          | -         | ⬜     |
| FR-006      | Stop                   | DoD: shutdown leak/race 测试 | -         | ⬜     |
| FR-007      | EventSink              | DoD: 所有 FR 有测试          | -         | ⬜     |
| FR-008      | Locker                 | DoD: 所有 FR 有测试          | TC-004    | ⬜     |
| FR-009      | Clock                  | DoD: DST/timezone golden 测试 | -         | ⬜     |
| BR-002      | 重复 JobID 返回 ErrDuplicateJob | -                    | -         | ⬜     |
| BR-005      | job panic 被 catch     | DoD: shutdown race 测试      | -         | ⬜     |
| BR-007      | DST 切换触发正确       | DoD: DST/timezone golden 测试 | -         | ⬜     |
...
| Requirement | Description          | Acceptance Criteria      | Test Case    | Status |
| ----------- | -------------------- | ------------------------ | ------------ | ------ |
| FR-001      | FakeConfig           | DoD: 所有 FR 有测试      | -            | ⬜     |
| FR-002      | FakeLogger           | DoD: 编译期接口检查      | -            | ⬜     |
| FR-003      | FakeMeter            | DoD: 编译期接口检查      | -            | ⬜     |
| FR-004      | FakeTracer           | DoD: 编译期接口检查      | -            | ⬜     |
| FR-005      | FakeClock            | DoD: 确定性 fake         | -            | ⬜     |
| FR-006      | FakeBreaker          | DoD: 编译期接口检查      | -            | ⬜     |
| FR-007      | Eventually           | DoD: 所有 FR 有测试      | -            | ⬜     |
| FR-008      | GoldenUpdate         | DoD: GOLDEN_UPDATE 环境变量 | -            | ⬜     |
| FR-009      | BoundaryCheck        | DoD: 生产 import 无 testkitx | -            | ⬜     |
| FR-010      | GoroutineLeakCheck   | DoD: 所有 FR 有测试      | -            | ⬜     |
...
| FR-004      | check release        | DoD: 所有 FR 有测试 | -                  | ⬜     |
| FR-005      | check all            | DoD: 所有 FR 有测试 | TC-004, TC-005     | ⬜     |
| FR-006      | 输出格式             | DoD: 所有 FR 有测试 | -                  | ⬜     |
...
| Requirement | Description          | Acceptance Criteria | Test Case       | Status |
| ----------- | -------------------- | ------------------- | --------------- | ------ |
| FR-001      | 命名规范             | DoD: 所有 FR 有测试 | -               | ⬜     |
| FR-002      | 错误规范             | DoD: 所有 FR 有测试 | -               | ⬜     |
| FR-003      | 接口规范             | DoD: 所有 FR 有测试 | -               | ⬜     |
| FR-004      | 目录规范             | DoD: 所有 FR 有测试 | -               | ⬜     |
| FR-005      | 配置规范             | DoD: 所有 FR 有测试 | -               | ⬜     |
| FR-006      | Gate 定义            | DoD: Gate 一致性    | TC-003          | ⬜     |
| FR-007      | Evidence 定义        | DoD: 所有 FR 有测试 | -               | ⬜     |
...
| FR-004      | Exists               | DoD: 所有 FR 有测试 | -         | ⬜     |
| FR-005      | Expire               | DoD: 所有 FR 有测试 | -         | ⬜     |
| FR-006      | HGet / HSet          | DoD: 所有 FR 有测试 | -         | ⬜     |
| FR-007      | LPush / LRange       | DoD: 所有 FR 有测试 | -         | ⬜     |
| FR-008      | Subscribe            | DoD: 所有 FR 有测试 | -         | ⬜     |
| FR-009      | Pipeline             | DoD: 所有 FR 有测试 | TC-003    | ⬜     |
| FR-010      | Locker.Acquire       | DoD: 所有 FR 有测试 | TC-002    | ⬜     |
| FR-011      | Locker.Release       | DoD: 所有 FR 有测试 | TC-002    | ⬜     |
| FR-012      | Health               | DoD: 所有 FR 有测试 | -         | ⬜     |
...
| FR-004      | Delete               | DoD: 所有 FR 有测试 | -         | ⬜     |
| FR-005      | List                 | DoD: 所有 FR 有测试 | -         | ⬜     |
| FR-006      | PresignURL           | DoD: 所有 FR 有测试 | -         | ⬜     |
| FR-007      | Health               | DoD: 所有 FR 有测试 | -         | ⬜     |
| FR-008      | Close                | DoD: 所有 FR 有测试 | -         | ⬜     |
| BR-001      | key 非空且不以 / 开头 | -                  | -         | ⬜     |
