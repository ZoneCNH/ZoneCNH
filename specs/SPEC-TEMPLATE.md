...
> FoundationX 模块规格模板。新建 `specs/{module}/SPEC.md` 时复制本文件。
>
...
| 文档 | 用途 |
|------|------|
| [`specs/LIFECYCLE.md`](./LIFECYCLE.md) | 规格生命周期状态机 |
| [`specs/TASK-TEMPLATE.md`](./TASK-TEMPLATE.md) | Task Spec 模板 |
| [`specs/AGENT-SPEC-TEMPLATE.md`](./AGENT-SPEC-TEMPLATE.md) | Agent Spec 模板 |
| [`specs/TRACEABILITY.md`](./TRACEABILITY.md) | 追溯矩阵 |
| [`specs/anti-requirements.md`](./anti-requirements.md) | 反需求 |
