...
| [natsx](https://github.com/ZoneCNH/natsx)                 | v1.0.2      | spec/code/release/live | factory-ready   | spec=100 mat=100 tsk=100 pln=100 prm=100 cod=100 | NATS L2 adapter；✅ .repo-contract.yaml；真实 dev auth live gate 已验证；GitHub Release 已发布                                                                          |
...
| natsx                         |      ✅       |                ✅                 |                ✅                |           ✅            |           ✅           |             N/A             |                      N/A                      |   ✅    | v1.0.2; GitHub Release 已发布; 6 CI workflows; dev auth live gate 已验证                                                               |
