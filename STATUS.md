...
| [xlib-evidence](https://github.com/ZoneCNH/xlib-evidence) | v1.1.0      | spec/code/release      | factory-ready   | spec=98 mat=100 tsk=100 pln=100 prm=100 cod=100  | 证据收集与发布运行时：collect-coverage、generate-manifest、validate-manifest、report；✅ CI 已部署；✅ GitHub Release v0.2.2 已发布（100% 覆盖率）                                                       |
...
| xlib-evidence                 |      ✅       |                ✅                 |                ✅                |           N/A           |           ✅           |             N/A             |                      N/A                      |   ✅    | v0.2.2; GitHub Release v0.2.2 已发布; evidence collect/generate/validate/report; CI 已部署（100% 覆盖率）                                                                          |
