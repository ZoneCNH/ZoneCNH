...
| [xlibgate](https://github.com/ZoneCNH/xlibgate)           | v1.0.0      | spec/code/release      | factory-ready   | spec=100 mat=100 tsk=100 pln=100 prm=100 cod=100 | check/l2/trust 三组门禁；✅ .repo-contract.yaml，release-preflight 与 manifest template 已对齐 v1.0.0；trust CLI 已实现；/home/xlibgate@98529ca 为当前发布对齐证据快照                                                        |
...
| xlibgate                      |      ✅       |                ✅                 |                ✅                |           N/A           |           ✅           |             N/A             |                      N/A                      |   ✅    | v1.0.0; CI 已部署; 8 workflows; release governance gates 已按 /home/xlibgate@98529ca 对齐                                                                 |
