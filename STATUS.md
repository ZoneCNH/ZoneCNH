...
| [ossx](https://github.com/ZoneCNH/ossx) | v1.0.1 | Spec→Code 完成 | 100% | spec=100 mat=100 tsk=100 pln=100 prm=100 cod=100 | Aliyun OSS L2 adapter；✅ .repo-contract.yaml，v1.0.1 已对齐；race/vet/build/release-check 已通过 |
