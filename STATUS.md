...
| [natsx](https://github.com/ZoneCNH/natsx) | v1.0.1 | █████ 100% | spec=100 mat=100 tsk=92 pln=100 prm=100 cod=100 | NATS L2 adapter：Core NATS / JetStream / Drain / reconnect / degraded health / canonical FOUNDATIONX_NATS_* 配置；TLS 已实现；matrix 26 行全覆盖；claude+rules 双源 100/100；codex/copilot 待补齐 |
