...
| [xlib-evidence](https://github.com/ZoneCNH/xlib-evidence) | v1.1.0      | spec/code/release      | factory-ready   | spec=98 mat=100 tsk=100 pln=100 prm=100 cod=100  | 证据收集与发布运行时：collect-coverage、generate-manifest、validate-manifest、report；✅ CI 已部署；✅ GitHub Release v0.1.0 已发布                                                       |
