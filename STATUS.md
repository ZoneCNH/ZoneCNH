...
| [kernel](https://github.com/ZoneCNH/kernel)               | v1.0.0      | spec/code/release      | non-factory     | spec=100 mat=100 tsk=100 pln=100 prm=100 cod=100 | L0 原语 / 12 子包 / stdlib-only；✅ .repo-contract.yaml，v1.0.0 已对齐；2026-06-18 代码侧验收全部通过（test/race/vet/coverage 100% / stdlib-only / secrets，evidence: `.config/goal/evidence/kernel-acceptance-20260618/`）；BLK-011 open，Goal Matrix / 四源 arbiter 闭合仍待 .config/goal pipeline                                                                                     |
| [configx](https://github.com/ZoneCNH/configx)             | v1.0.0 (tag) / v0.1.4 (runtime) | spec/code/release      | factory-ready   | spec=100 mat=100 tsk=100 pln=100 prm=100 cod=100 | 配置管理；v1.0.0 git tag 已发布；运行时 version.go=v0.1.3 / CHANGELOG=v0.1.4 / repo-contract=v0.1.4，goal.md v1.0 完整 MUST 推迟 v1.1（详见 module/configx/ACCEPTANCE.md 版本基线说明）；✅ .repo-contract.yaml |
...
| kernel                        |      ✅       |                ✅                 |                ✅                |           N/A           |           ✅           |             ✅              |                      N/A                      |   ❌    | v1.0.0; 4 CI workflows; 13 下游消费者; 2026-06-18 代码侧验收全部通过（evidence: kernel-acceptance-20260618）；BLK-011 open，Goal Matrix / 四源 arbiter 待闭合                                                                             |
| configx                       |      ✅       |                ✅                 |                ✅                |           N/A           |           ✅           |             ✅              |                      N/A                      |   ✅    | v1.0.0 tag / v0.1.4 runtime; GitHub Release 已发布; 4 CI workflows; 2 下游消费者                                                                        |
