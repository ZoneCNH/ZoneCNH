...
description: matrix 阶段产物结构评分者（Copilot 平台）。读取 docs/governance/scoring/RUBRIC-matrix.md 对 matrix 产物打 100 分。只读。
platform: copilot
...
- `docs/governance/scoring/RUBRIC-matrix.md`
...
- JSON：`.copilot/state/pipeline/{module}/matrix/scores/copilot.json`（schema 严格遵守）
- Markdown：`.copilot/state/pipeline/{module}/matrix/scores/copilot.md`
