...
- `total_gate_failures >= 18` → `pipeline_blocked_for_retrospective`，写入 `.copilot/state/pipeline/{module}/pipeline_blocked.json` 与 `specs/{module}/PIPELINE-RETROSPECTIVE.md`，停止进入下一阶段。
