...
| 分析域                | [market_regime](https://github.com/ZoneCNH/market_regime)       | v0.1.0       | 🔨 已创建 | ████ 40%       | 市场状态识别（S1-S7：多头趋势/挤空/空头/踩踏/震荡/低波/压缩），5D特征+规则分类器，5 tests PASS                                                                                                                                                                                                                                                                                   |
| 分析域                | [macro_regime](https://github.com/ZoneCNH/macro_regime)         | v0.1.0       | 🔨 已创建 | ████ 40%       | 宏观经济体制识别（M1-M7：流动牛市/再通复苏/软着繁荣/鹰派通胀/衰退降息/信用去杠/滞胀冲击），LGIP四因子+分类器                                                                                                                                                                                                                                                                     |
...
| 执行域                | [portfolio_engine](https://github.com/ZoneCNH/portfolio_engine) | ~~占位~~     | 🔨 已创建 | ░░░░ 5%        | ~~投资组合~~ → [**positionx**](https://github.com/ZoneCNH/positionx)                                                                                                                                                                                                                                                                                                             |
