...
| 数据域                | [binance](https://github.com/ZoneCNH/binance)                   | v0.13.0 / spec v3.14.0 | ✅ 已发布 | 55 Done / 0 Partial / 0 Drifted / 0 Pending | Binance Market Data C/S Module；Runtime-Anchor `/home/workspace/binance@main`；deep-review 37/37 fixed (PR #229)；coverage 100.0%；production release v0.13.0 |
