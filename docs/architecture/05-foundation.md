...
| 数据域                | [binance](https://github.com/ZoneCNH/binance)                   | v0.2.0 / spec v3.7.1 | ✅ 已发布 | 24 Done / 10 Partial / 10 Pending | Binance Market Data C/S Module；Runtime-Anchor `/home/binance@f046e16`；PR #145 + #1189 合并；FR-037~044 Pending + FR-031~036 Draft |
