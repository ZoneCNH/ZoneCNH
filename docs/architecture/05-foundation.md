...
| 数据域                | [binance](https://github.com/ZoneCNH/binance)                   | v3.5.0 (spec) | ⚠️ 待 runtime/release 证据 | ░░░░ 3%       | Binance Market Data C/S Module；FR-009 本地 boundary evidence 已归档（验证代码 `9777a5b0db9a3de5db53942b9aaf6b55eec04f24`，证据提交 `20c7712935f53e1948bdf4b30a72d3db07f9acfb`）；FR-001/002 Partial，FR-003~008/010~030 Pending；FR-012~030 追溯登记；4 产品线 / 4×6 event matrix 文档口径；live websocket/外部集成/remote CI/release tag 未闭合 |
