...
| 数据域                | [binance](https://github.com/ZoneCNH/binance)                   | v0.2.0 / spec v3.9.0 | ✅ 已发布 | 22 Done / 26 Partial / 0 Drifted / 0 Pending | Binance Market Data C/S Module；Runtime-Anchor `/home/binance@f046e16`；Evidence-State `1 Done (FR-009) / 43 Pending`；FR-031~044 已有本地 code anchors，production gates 仍 blocked |
