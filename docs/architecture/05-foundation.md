...
| 数据域                | [binance](https://github.com/ZoneCNH/binance)                   | v3.5.0 (spec) | ⚠️ 待证据 | ░░░░ 15%       | Binance Market Data C/S Module；FR-012~030 追溯登记；runtime/release evidence Pending；4 产品线 / 4×6 event matrix 文档口径                                                                                                                                                                                                                                                    |
