...
| 数据域                | [binance](https://github.com/ZoneCNH/binance)                   | v0.2.0 / spec v3.9.0 | ✅ 已发布 | 23 Done / 25 Partial / 0 Drifted / 0 Pending | Binance Market Data C/S Module；Runtime-Anchor `/home/binance@f046e16`；Evidence-State `1 Done (FR-009) / 43 Pending`；FR-037 本地部署安全网 code gate 已闭合，production canary / rollback / live evidence 仍 pending |
