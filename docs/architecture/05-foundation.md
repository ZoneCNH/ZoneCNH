...
| 数据域                | [binance](https://github.com/ZoneCNH/binance)                   | v0.2.0 / spec v3.6.0 | ✅ 已发布 | 24 Done / 10 Partial | Binance Market Data C/S Module；Plan008 final closeout 已归档：GitHub Release `v0.2.0` + workflow `28126779885` completed/success，`release_closeable=YES`；GitHub `plan008` #1132-#1171 40/40 CLOSED，beads `plan008` 40/40 `closed`；FR 投影以 `module/binance/README.md` / `TRACEABILITY.md` 的 `24 Done / 10 Partial / 0 Pending` 为准，不由 release gate 自动升格为 30/30 Done |
