...
> 迁移自 `module/binance/spec/SPEC.md` Appendix D（v3.9.0 迁移）。本文件是 v2.0.0 时期的验收口径快照，仅覆盖 FR-001~FR-011 共 18 条 AC。当前模块已扩展至 44 FR / 130 AC，完整 AC 注册表维护于 [module/binance/matrix/TRACEABILITY.md §5](../../module/binance/matrix/TRACEABILITY.md#5-ac--tc-完整映射)，实现状态见 [module/binance/spec/ACCEPTANCE.md §2](../../module/binance/spec/ACCEPTANCE.md#2-功能验收矩阵) 与 [module/binance/matrix/TRACEABILITY.md §6](../../module/binance/matrix/TRACEABILITY.md#6-覆盖率仪表盘)。

> **弃用声明**：本 Registry 是 v2.0.0 时期的验收口径快照，仅覆盖 FR-001~FR-011 共 18 条 AC（编号 AC-BNC-001 ~ AC-BNC-018）。当前模块已扩展至 44 FR / 130 AC（AC-001 ~ AC-130），完整 AC 注册表单点维护于 [module/binance/matrix/TRACEABILITY.md §5](../../module/binance/matrix/TRACEABILITY.md#5-ac--tc-完整映射)，实现状态见 [module/binance/spec/ACCEPTANCE.md §2](../../module/binance/spec/ACCEPTANCE.md#2-功能验收矩阵) 与 [module/binance/matrix/TRACEABILITY.md §6](../../module/binance/matrix/TRACEABILITY.md#6-覆盖率仪表盘)。
>
