...
| `REQ-SPEC-goalctl-v1-012` | `goalctl` 必须校验 Evidence 必填字段。 | `AC-REQ-SPEC-goalctl-v1-012-001` | 缺少 Evidence ID、Task ID、Test ID、Goal ID、Date、Status、Files Changed、Commands Run 任一字段时严格模式失败。 |
