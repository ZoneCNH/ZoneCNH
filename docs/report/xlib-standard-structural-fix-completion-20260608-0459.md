...
```text
specs/xlib-standard/SPEC.md (2030 行)
...
specs/xlib-standard/COVERAGE-MANIFEST.md (382 行)
...
- 修复后规格：`specs/xlib-standard/{SPEC,README,TRACEABILITY,CONFLICT-LEDGER,COVERAGE-MANIFEST}.md`
