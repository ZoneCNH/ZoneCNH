...
- Scope: `docs/report/fred/` 全部 4 份报告 + `module/fred/` 全部 7 份模块文件
...
| `docs/report/fred/deep-analysis-20260622.md` | P0 三项（BR 漂移、边界冲突、配置映射）+ P1 四项 + 推荐迭代顺序 | [COMPUTED][HIGH] |
| `docs/report/fred/data-issues-resolution-20260622.md` | FRED 官方语义、历史/实时数据方案、同步对象/周期、清洗规则、缺口检测、七介质职责 | [COMPUTED][HIGH] |
| `docs/report/fred/ms_brain-integration-analysis-20260622.md` | ms_brain 消费画像、初始序列锚点、PIT/no-lookahead、freshness/degrade 契约 | [COMPUTED][HIGH] |
| `docs/report/fred/structural-score-20260622.md` | SPEC 84/100、结构健康 68/100、发布就绪 42/100；G2/G3 Fail | [COMPUTED][HIGH] |
