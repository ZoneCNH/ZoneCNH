...
- [COMPUTED][HIGH] 范围：`module/fred/` 规格文档、`docs/report/fred/` 既有报告、`/home/fred` 当前实现。
...
- [COMPUTED][HIGH] 既有报告：`docs/report/fred/deep-analysis-20260622.md`、`docs/report/fred/structural-score-20260622.md`。
