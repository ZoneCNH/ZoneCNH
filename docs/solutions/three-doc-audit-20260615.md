...
| # | 检查 | 结果 |
|---|------|:----:|
| A | 79 = 55(≥80%) + 1(25%) + 22(5%) + 1(未标注) | PASS |
| B | 79 = 57(已有) + 22(已创建) | PASS |
| C | 79 = 37(有版本号) + 42(无版本号) | PASS |
...
```
 79 = 55 + 1 + 22 + 1          (进度分布 = 组件总数)
 79 = 57 + 22                  (已有 + 已创建 = 组件总数)
 79 = 37 + 42                  (有版本号 + 无版本号 = 组件总数)
 77 = 77 = 77                  (README / ARCH / STATUS unique repos 一致)
