...
> **补充**：完整的 RSI 分级标准（R0-R5）、四层边界（模型/系统/组织/生态）、三条红线、Gate A-X 放行门禁、T1-T15 不可接受风险阈值详见 [`26-rsi-full-standard.md`](26-rsi-full-standard.md)（RSI-SG-001）。本文聚焦工程工作流层面的可控改进，26 号文覆盖 RSI 的全谱系治理。
