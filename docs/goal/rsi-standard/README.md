...
> **⚠️ 参考附录（非权威）。** 本子目录是 RSI 完整标准（RSI-SG-001）的只读参考附录，提供理论背景与扩展场景。日常工程工作流的权威规则以 [21-controlled-rsi.md](../21-controlled-rsi.md) 为 SSOT。本附录内容不作为当前强规则源；与 21 冲突时以 21 为准。
