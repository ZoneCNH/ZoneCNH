...
1. 写 JSON 报告到：`.omx/state/pipeline/{module}/prompt/scores/claude.json`，schema 严格遵守 `STRUCTURAL-SCORING.md` §3。
2. 同步 Markdown 到：`.omx/state/pipeline/{module}/prompt/scores/claude.md`。
