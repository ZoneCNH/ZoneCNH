...
| 基座                  | [clickhousex](https://github.com/ZoneCNH/clickhousex)           | v1.0.1 | ✅ 已发布 | Spec→Code 完成 | ClickHouse — OLAP 查询、批量写入；v1.0.1 GitHub Release 已发布；v1.0.2 foundation 本地 tag/质量门禁证据已记录，远端 v1.0.2 Release 与 CI 未闭合；BLK-003 open；非 factory |
