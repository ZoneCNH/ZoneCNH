...
| 基座                  | [clickhousex](https://github.com/ZoneCNH/clickhousex)           | v1.0.2 | ✅ 已发布 | Spec→Code 完成 | ClickHouse — OLAP 查询、批量写入；v1.0.2 GitHub Release 已发布；foundation 本地质量门禁证据已记录；远端 CI/live ClickHouse 证据待闭合；BLK-003 open；非 factory |
