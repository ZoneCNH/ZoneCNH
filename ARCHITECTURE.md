...
| **L2.5 · 领域共享层** |                                                                 |        |           |          |                                                                                           |
| L2.5                  | [domainx](https://github.com/ZoneCNH/domainx)                   | v1.0.1 | ✅ 已有   | Spec→Code 完成 | 领域共享值对象基线：Order/Position/Trade/Portfolio/ExecutionReport 与 OrderState/OrderType/OrderSide 枚举（8 FR，8 TC，6 tasks）；公开 v1.0.1 GitHub Release/tag 已观测并完成 release 对账；非 factory until adoption/factory evidence archived |
| L2.5                  | [decimalx](https://github.com/ZoneCNH/decimalx)                 | v1.0.0 | ✅ 已有   | Spec→Code 完成 | 高精度十进制类型（Decimal/Price/Qty/Ratio/Money）；v1.0.0 GitHub Release 已发布；8 FR Done |
| L2.5                  | [domain-market](https://github.com/ZoneCNH/domain-market)       | v1.0.0 | ✅ 已有   | Spec→Code 完成 | 市场数据域模型（Tick/Quote/Bar/OrderBook）；v1.0.0 GitHub Release 已发布；7 FR Done        |
| L2.5                  | [domain-exchange](https://github.com/ZoneCNH/domain-exchange)   | v1.0.0 | ✅ 已有   | Spec→Code 完成 | 交易域模型（VenueAdapter 13 方法接口）；v1.0.0 GitHub Release 已发布；7 FR Done            |
| L2.5                  | [domain-macro](https://github.com/ZoneCNH/domain-macro)         | v1.0.0 | ✅ 已有   | Spec→Code 完成 | 宏观数据域模型（MacroPoint/MacroState）；v1.0.0 GitHub Release 已发布；7 FR Done           |
| **数据域 · 行情**     |                                                                 |        |           |          |                                                                                           |
