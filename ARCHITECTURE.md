...
- **参考实现**：binance（spec v2.1.2 Approved 分布式：natsx + 7 infra + Gin；runtime v0.2.0 bootstrap + Spot 产品线 Partial；进度 15%）
