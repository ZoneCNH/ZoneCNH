...
| **展示层**            |                                                                 |        |           |          |                                                                                           |
| 展示层                | [frontend](https://github.com/ZoneCNH/frontend)                 | v1.0.0 | ✅ 已发布 | Spec→Code 完成 | ZoneCNH 统一前端平台 — React 19 + TypeScript + Vite + Tailwind CSS 4 + Recharts；多模块路由；binance 5 页面 39 功能 Done；nginx 静态部署；Playwright 18 E2E |
| **数据域 · 行情**     |                                                                 |        |           |          |                                                                                           |
