...
| 基座                  | [kafkax](https://github.com/ZoneCNH/kafkax)                     | -      | ✅ 已有   | ████░ 90% | Kafka — L2 adapter 1.0 候选；driver-neutral API + 可选 kafka-go 生产驱动，真实 broker gates/release-check/score 10/10 已验证，PR/tag 待合入 |
