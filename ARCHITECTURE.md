...
| 数据域                | [binance](https://github.com/ZoneCNH/binance)                   | v0.2.0 ✅ / v3.9.6 (spec) | ✅ 已发布 | ████ 100% | **C/S Module 规格参考实现**：48/48 Done (100%)；release_closeable=YES 🎉；v0.2.0 tag 已发布；15/15 gates；21/21 tests |
