...
| **数据域 · 行情**     |                                                                 |        |           |          |                                                                                           |
| 数据域                | [market-data](https://github.com/ZoneCNH/market-data)           | v1.0.0 | ✅ 已发布 | ██░░ 30% | Downstream Dispatch Port 接收侧（FR-MD-001~008）；dispatch.go 已实现；v1.0.0 released                                  |
| 数据域                | [binance](https://github.com/ZoneCNH/binance)                   | v0.1.0      | ✅ 已有 | ░░░░  5% | Binance Market Data C/S Module (client+server)；Spec Approved；4产品线；spec v1.0.0                       |
