...
- **规格参考实现**：binance（spec v3.1.0 Approved 分布式：natsx + 7 infra + Gin；runtime v0.2.0 bootstrap + Spot 产品线状态以 runtime 仓为准；进度 15%；runtime release blocked；FR-012~024 追溯登记）
