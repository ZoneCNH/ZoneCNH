...
| 基座                  | [redisx](https://github.com/ZoneCNH/redisx)                     | v1.0.0 | ✅ 已发布 | ████░ 90% | Redis L2 adapter：KV/TTL/Hash/List/Pipeline/Cache-aside/Lock/RateLimit/Pool/Persistence restart recovery；release_ready=true，score 92；dev 环境未暴露兼容的 REDISX_REDIS_* 端点变量；未打印/记录 secret；使用 Docker-backed Redis 验证。 |
