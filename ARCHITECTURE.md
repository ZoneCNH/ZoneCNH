...
| 基座                  | [testkitx](https://github.com/ZoneCNH/testkitx)                 | v0.4.0 | ✅ 已发布 | ███░ 90% | 测试专用 fake/fixture/golden/contract/boundary/leak 工具包，PR #13 code 阶段完成（80.7% 覆盖），禁止生产导入 |
...
| 基座                  | [xlibgate](https://github.com/ZoneCNH/xlibgate)                 | v1.0.0 | ✅ 已发布 | ███░ 95% | check / l2 / trust 三组门禁；trust Alignment 规格/设计/计划/任务/提示词/代码完备（8 FR, 16 TC, 44 tests） |
...
| 基座                  | [postgresx](https://github.com/ZoneCNH/postgresx)               | v1.0.0 | ✅ 已发布 | ████░ 90% | PostgreSQL — 关系型存储、事务、迁移（v1.0 发布范围 100/100；全局成熟度待生产 soak 后提升） |
