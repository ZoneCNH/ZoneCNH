...
| 基座                  | [kafkax](https://github.com/ZoneCNH/kafkax)                     | v1.0.0 | ✅ 已发布 | █████ 100% | Kafka — L2 adapter [v1.0.0](https://github.com/ZoneCNH/kafkax/releases/tag/v1.0.0) 已发布；[PR #5](https://github.com/ZoneCNH/kafkax/pull/5) 已合入；driver-neutral API + 可选 kafka-go 生产驱动，真实 broker gates/release-check/score 10/10 已验证，tag 指向 `0545db2` |
