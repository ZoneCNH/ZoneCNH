...
Source: [spec/SPEC.md](../spec/SPEC.md) | Goal: GOAL-ECB-001 | Status: Planned
...
| G-SC-004 完整持久化 | FR-004, FR-006 | BR-002, BR-004, BR-005 | AC-004 |
| G-SC-005 同步与回补 | FR-003, FR-008, FR-009 | BR-002, BR-005 | AC-005 |
| G-SC-006 下游稳定契约 | FR-007 | BR-001, BR-004 | AC-006 |
...
| FR-003 | ECB 采集清单覆盖 | AC-005 | Planned |
