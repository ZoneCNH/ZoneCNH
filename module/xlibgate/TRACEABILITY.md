...
> 更新：2026-06-18（Matrix v1.6 — /home/xlibgate@98529ca release governance alignment：FR-012~FR-019、BR-010 实现状态回填，release-preflight/manifest 对齐 v1.0.0；NFR-011~NFR-018 转为 benchmark 待验证）
...
> FR-001~FR-011：check + l2 子命令组已完成并投影至 v1.0.0 release gate，AC/TC 追溯链闭合
> FR-012~FR-019：trust 子命令组已在 /home/xlibgate@98529ca 回填为已实现；release-preflight/manifest template 使用 v1.0.0
...
> NFR-011~018：trust 子命令组功能已实现，benchmark 目标仍待正式验证
...
| 日期 | 版本 | 变更 |
|------|------|------|
| 2026-06-18 | v1.6 | 发布对齐回填：以 /home/xlibgate@98529ca 为证据，将 FR-012~FR-019 与 BR-010 标记为已实现；NFR-011~NFR-018 调整为 benchmark 待验证；同步 release-preflight/manifest template v1.0.0。 |
