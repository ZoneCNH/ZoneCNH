...
WHEN 检测到私有端点（IPv4 loopback、loopback hostname、10.x.x.x、172.16-31.x.x、192.168.x.x），但以下开发上下文豁免：文件路径含 `test/`、`testdata/`、`_test.go`、`.md` 中的示例代码块标记为 `dev-only`、`README.md` 的本地开发章节
