...
| --- | --- | --- | --- | --- |
| AC-001 | Build(ctx, Spec{Module, Stores: None}) 返回 App，App.Stores 为 nil，Spec.Module 为空返回 ErrEmptyModule | FR-001, TC-001, TC-003, TASK-BS-001 | 已登记，需运行 `go test -run TestBuildAdapter` 与 `go test -run TestBuildEmptyModule` 复验 | SPEC.md §6/§16 |
| AC-002 | Build 使用 configx loader、XGO_ 环境源与 SecretString 脱敏，并暴露 ConfigHash | FR-002, FR-008, NFR-003, TASK-BS-002 | 已登记，需单测/人工审查证据 | SPEC.md §6/§9/§19 |
| AC-003 | Build/Run/Shutdown 接入 observex、resiliencx、lifecycx，支持顺序 Start、逆序 Stop、失败回滚与幂等 Shutdown | FR-003, FR-005, FR-006, FR-007, TC-005..TC-007, TASK-BS-003 | 已登记，需运行 lifecycle 相关测试复验 | SPEC.md §6/§9.3/§16 |
| AC-004 | Stores=None 路径端到端就绪；非 None 存储位目标态进入 v0.2.0 准入 | FR-004, TC-002, TC-004, TASK-BS-001 | v0.1.0 已发布 Stores=None；Stores=All/组合冒烟待 v0.2.0 | SPEC.md §6/§16/§22 |
| AC-005 | 边界门禁阻止 domain/contracts/数据域子模块/server 监听和越界依赖 | BR-001..BR-008, TC-008..TC-009, TASK-BS-004 | v0.1.0 boundary-gates.sh 5 道已通过，需复验脚本证据 | SPEC.md §7/§20/§22 |
| AC-006 | foundationx 遗留依赖按 OQ-004 清零，不晚于 v0.2.0 准入 | OQ-004, v0.2.0 DoD, TASK-BS-005 | Open | SPEC.md §15.1/§22/§23 |

## 3. TC 测试验收登记

| ID | 测试项 | 关联要求/验收/任务 | 当前登记状态 | 来源 |
| --- | --- | --- | --- | --- |
| TC-001 | FR-001 | Build 成功，Stores=None，App.Stores 为 nil / go test -run TestBuildAdapter | v0.1.0 Stores=None 已发布；需运行复验 | TRACEABILITY.md §1 |
| TC-002 | FR-001 | Build 成功，Stores=All，App.Stores 全非 nil / go test -run TestBuildAggregate | v0.2.0 准入；当前非 None 存储仍待完成 | TRACEABILITY.md §1 |
| TC-003 | FR-001 | Spec.Module 为空 → ErrEmptyModule / go test -run TestBuildEmptyModule | 已登记，需运行复验 | TRACEABILITY.md §1 |
| TC-004 | FR-004 | Stores=TD\|PG，仅构造 TD+PG，其余 nil / go test -run TestBuildPartialStores | v0.2.0 准入；需补充部分组合冒烟 | TRACEABILITY.md §1 |
...
| --- | --- | --- | --- | --- |
| FR-001 | Build 入口 | AC-001 / TC-001, TC-003 / TASK-BS-001 | v0.1.0 Stores=None 已发布；需运行时代码复验 | TRACEABILITY.md §1 |
| FR-002 | configx 加载 | AC-002 / TC-001 / TASK-BS-002 | 已登记，需单测或人工审查证据 | TRACEABILITY.md §1 |
| FR-003 | observex 初始化 | AC-003 / TC-005..TC-007 / TASK-BS-003 | v0.1.0 已发布，需 lifecycle 测试与 CI 证据复验 | TRACEABILITY.md §1 |
| FR-004 | stores 可选构造 | AC-004 / TC-002, TC-004 / TASK-BS-001, TASK-BS-005 | Stores=None 已发布；非 None 存储为 v0.2.0 准入 | TRACEABILITY.md §1 |
| FR-005 | lifecycle 编排 | AC-003 / TC-005..TC-007 / TASK-BS-003 | 已登记，需运行时复验 | TRACEABILITY.md §1 |
...
| NFR-002 | 稳定性 | AC-001, AC-003, AC-004 / API review / TASK-BS-001, TASK-BS-003 | 已登记，需复验 | TRACEABILITY.md §2 |
| NFR-003 | 边界纯净 | AC-002, AC-005 / static review / TASK-BS-002, TASK-BS-004 | 已登记，需复验 | TRACEABILITY.md §2 |
| NFR-004 | 可观测 | AC-003 / observability review / TASK-BS-003 | 已登记，需补充指标证据 | TRACEABILITY.md §2 |
| NFR-005 | 零存储默认 | AC-004 / TC-001, TC-009 / TASK-BS-001 | v0.1.0 已发布；需复验 | TRACEABILITY.md §2 |
