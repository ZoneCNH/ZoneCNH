...
| FR-003 | Endpoint Model — 校验scheme/authority/path/topic/partitionKey/capability/tenantScope/owner | Functional | SPEC §7 | AC-003 | TC-003 | TASK-TRANSPORTX-002 | Pending |
| FR-004 | Runtime Lifecycle — 强制执行Start/Pause/Resume/Drain/Shutdown/ForceStop生命周期状态机 | Functional | SPEC §7 | AC-004 | TC-004 | TASK-TRANSPORTX-004 | Pending |
