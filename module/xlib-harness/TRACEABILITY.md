...
| NFR-004 | Dependency Boundary | 允许只读 xlib-standard 模板；禁止 github.com/ZoneCNH/xlib-standard Go import/module dependency，并禁止 observex/configx/resiliencx/schedulex/业务域模块 | dependency graph analysis: `go list -deps` / `go list -m` + boundary allow/deny list | ✅ |
