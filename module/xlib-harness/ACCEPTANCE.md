...
| Benchmark | `cd /home/xlib-harness && go test -bench=. -run '^$' ./...` | PASS |
| Trust Imports | `cd /home/xlib-harness && GOWORK=off xlibgate check imports -path .` | PASS |
| Trust Go Module | `cd /home/xlib-harness && GOWORK=off xlibgate check gomod -path .` | PASS |
| Trust Baseline | `cd /home/xlib-harness && GOWORK=off xlibgate check baseline -path . -expected 1.23` | PASS |
| Secret Scan | `cd /home/xlib-harness && gitleaks detect --source . --redact --verbose` | PASS |
...
- Local tag `v0.1.6` points at `/home/xlib-harness@d90b35124701`.
...
| Coverage | 100/100 | `go tool cover -func=/tmp/xlib-harness-v016.cover` total 100.0%，每个函数 100.0% |
