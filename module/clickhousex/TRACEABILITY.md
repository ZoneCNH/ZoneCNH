...
> 更新：2026-06-29（Matrix v1.2 — Goal 管线对齐：§1-§5 章节标准化，§6 覆盖率仪表盘）
...
> 说明：v1.0.1 为规格基线版本，所有 FR/BR/NFR 初始状态均为 Pending（⬜）。Task 总数 = TASK-CLICKHOUSEX-001 ~ 007 共 7 项。
...
| 日期 | 版本 | 变更 |
|------|------|------|
| 2026-06-29 | v1.2 | Goal 管线对齐：§1-§5 章节标题统一为 § 前缀格式；§2 BR 表补全独立章节标题；§6 覆盖率仪表盘标准化为 Done/覆盖率列格式；BR/NFR 表头统一 Task 列位置 |
