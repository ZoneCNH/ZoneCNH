...
| G-SC-005 下游稳定契约 | FR-010, FR-013, FR-014 | BR-001, BR-004, BR-008 | AC-005, AC-007 | TC-006 |
...
| TC-005 | `go test ./internal/server/... -run NoLookahead` |
| TC-006 | `bash scripts/boundary-gates.sh && go test ./...` |
