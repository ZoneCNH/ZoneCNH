...
> 说明：全部 FR/BR/NFR/AC/TC 标记 Done。Task 总数 = TASK-KERNEL-000~016 共 23 项（含子任务）。
...
| 日期 | 版本 | 变更 |
| --- | --- | --- |
| 2026-06-29 | v2.4 | Goal 管线对齐：§1-§7 章节标题统一为 § 前缀格式；§5 AC 注册表修正多余空列；§6 覆盖率仪表盘标准化为 Done/覆盖率格式；新增 Last-Updated 行 |
