...
> **Status**: Accepted（2026-07-05 — Phase 0-4 已实施：contracts v0.5.0 canonical 富化 + binance `internal/wire` 删除 + `internal/ingestcodec` boundary 建立，build/test/race/boundary-gates 15/15 全绿）
> **Date**: 2026-07-05
> **Accepted**: 2026-07-05
...
> **仓库归属**: ZoneCNH 主仓 `module/binance/`；代码实施在 `contracts`（v0.5.0）与 `binance`（feat branch）runtime 仓
