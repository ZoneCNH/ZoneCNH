...
在 `module/binance/server/docs/PERSISTENCE-WIRING.md` 已记录 storageFromEnv 装配契约。建议在 bootstrap 仓（或 ZoneCNH 架构文档）补充：
...
- 建议：在 server/docs/PERSISTENCE-WIRING.md §1 补一句「本文件定义 binance 的 composition root（装配层）」
