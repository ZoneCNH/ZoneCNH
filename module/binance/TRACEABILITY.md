...
> **v3.6.2 Plan008 overlay (2026-06-26)**：对齐 Runtime-Anchor `/home/binance@e32a126391ab03dcddcbc31945fcf2dc757e8025`（latest local follow-up）、Remote CI Anchor `ZoneCNH/binance#145@a991c46c7959ad533196e9392c90a04734de2eda` 与 Plan008 issue ledger `plans/binance/008-issues-sync-report.md`。Plan008 T008.001-T008.038 已具备本地与 PR CI closure evidence；T008.039/T008.040 保持 release-gated open。partial-live 已捕获 JetStream、storage assembly、Kafka roundtrip、Binance Spot/bookTicker/UM/CM/Options WS 与 OSSX archive/list/delete live I/O；latest local follow-up 已补 options expiry aggregate normalization、bounded Options live selector、`efb63f8` exact-key parser 与 `BINANCE_OSSX_LIVE` archive/list/delete opt-in gate。该 overlay 不自动上调 FR Done/Partial 投影：当前 release-state baseline 仍为 v3.6.1 的 24 Done / 10 Partial / 0 Pending，直到 release tag artifact / release publication evidence 归档。
