...
> **v3.6.2 Plan008 overlay (2026-06-25)**：对齐 Runtime-Anchor `/home/binance@d8668243cab999549bedfb60b7ffc8781f7190f2` 与 Plan008 issue ledger `plans/binance/008-issues-sync-report.md`。Plan008 T008.001-T008.038 已具备本地与 PR CI closure evidence；T008.039/T008.040 保持 release-gated open。该 overlay 不自动上调 FR Done/Partial 投影：当前 release-state baseline 仍为 v3.6.1 的 24 Done / 10 Partial / 0 Pending，直到 live Binance、外部 JetStream ack、外部 durable storage/fanout/query、release tag、chaos/SLO evidence 捕获。
