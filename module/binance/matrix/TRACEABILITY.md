...
> [COMPUTED, HIGH] **FR-031~036 规格（v3.8.0 Active）**：原定义于 `SPEC-exchangeinfo-sync.md`（Draft），v3.8.0 合并入根 SPEC.md §7。2026-06-28 全量 E2E 证据闭合后状态为 Code-Partial / Evidence-Done。
