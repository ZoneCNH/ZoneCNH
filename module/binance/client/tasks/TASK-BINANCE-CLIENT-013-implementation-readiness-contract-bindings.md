...
- Dependencies: `module/contracts/SPEC.md` §8.4, `module/domain-market/SPEC.md` v1.1.0 §10
...
2. Client mapper uses `MarketFactEnvelope` naming and time semantics from domain-market §10.
