...
| Executable test evidence | 5/5 | `/home/workspace/natsx/pkg/natsx` embedded tests cover lifecycle/delivery edges, benchmarks, canonical/legacy env loading tests, handler latency/metric assertions, embedded request/JetStream SLO smoke assertions, and a gated redacted dev live integration test. |
...
- Executable evidence is pinned to `/home/workspace/natsx` commit `20f801f`.
