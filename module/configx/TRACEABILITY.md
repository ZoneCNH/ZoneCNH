...
> 更新：2026-06-18（v3.1 — v1.1.0 发布对齐：新增 FR-014~018、BR-012、TC-010~014，覆盖 v1.0 路线 5 项 MUST）
...
| 指标          | 数值         | 说明                  |
| ------------- | ------------ | --------------------- |
| FR 总数       | 18           | FR-001 ~ FR-018       |
| FR 有 TC 覆盖 | 18/18 (100%) |                       |
| BR 总数       | 12           | BR-001 ~ BR-012       |
| BR 有 TC 覆盖 | 12/12 (100%) |                       |
| NFR 总数      | 7            | NFR-001 ~ NFR-007     |
| AC 总数       | 10           | AC-001 ~ AC-010       |
| TC 总数       | 14           | TC-001 ~ TC-014       |
| 实现覆盖率    | **96.5%**    | go test -coverprofile (v1.1.0；含 6 大新模块) |
