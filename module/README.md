...
**参考实现**：[binance](https://github.com/ZoneCNH/binance)（spec v2.1.2 Approved，runtime v0.2.0 bootstrap 接入；FR-001/002 Spot 产品线 Partial + FR-009 边界 gate 落地 + TC-020 PASS；进度 15%；USDM/COINM/Options 与 FR-003~011 待 PR-007）
