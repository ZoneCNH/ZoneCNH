...
| clickhousex | [SPEC.md](./clickhousex/SPEC.md) · [TRACEABILITY.md](./clickhousex/TRACEABILITY.md) · [goal.md](./clickhousex/goal.md) · [FEATURES.md](./clickhousex/FEATURES.md) · [ACCEPTANCE.md](./clickhousex/ACCEPTANCE.md) · [tasks/](./clickhousex/tasks/) | ClickHouse — OLAP 查询、批量写入（v1.0.5 GitHub Release 已发布；Exec/Query/Rows/InsertBatch、metrics/tracing/logger/retry/error mapping 与 100.0% 覆盖率门禁已对齐；branch/tag Actions quality/lint/integration/secret-scan/trust/release-check 已通过；BLK-003 open；非 factory）                                                                     |
