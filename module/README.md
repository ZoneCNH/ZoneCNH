...
| ossx        | [SPEC.md](./ossx/SPEC.md) · [TRACEABILITY.md](./ossx/TRACEABILITY.md) · [goal.md](./ossx/goal.md) · [FEATURES.md](./ossx/FEATURES.md) · [IMPLEMENTATION-PLAN.md](./ossx/IMPLEMENTATION-PLAN.md) · [tasks/](./ossx/tasks/) · [prompt/](./ossx/prompt/) | Aliyun OSS 对象存储 L2 adapter（v1.0.2-alpha 已交付 pkg/ossx 源码/8文件/34KB/12测试/stdlib-only/import 可编译；BLK-010 resolved；非 factory：真实 Aliyun adapter + integration evidence 仍缺，由 TASK-OSSX-005 跟踪） |
