...
- 模块采用全版本化结构：`v{版本}/` 下自包含管线快照（goal/spec/design/plan/tasks/prompt/evidence）+ 跨版本层 `matrix/gate/schema` 存于模块根；Goal 文档位于 `module/{module}/v{版本}/goal/goal.md`。
...
命名规则：每个模块一个 Goal 文档，路径固定为 `module/{module}/v{版本}/goal/goal.md`。
