...
**参考实现**：[binance](https://github.com/ZoneCNH/binance)（spec v2.2.3 Approved，runtime v0.2.0 bootstrap 接入；FR-001/002 状态以 runtime 仓为准（追溯矩阵已标 Pending） + FR-009 边界 gate 落地 + TC-020 PASS；进度 15%；USDM/COINM/Options 与 FR-003~011 待 PR-007）
