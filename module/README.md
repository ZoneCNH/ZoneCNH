...
| clickhousex | [SPEC.md](./clickhousex/SPEC.md) · [TRACEABILITY.md](./clickhousex/TRACEABILITY.md) · [goal.md](./clickhousex/goal.md) · [FEATURES.md](./clickhousex/FEATURES.md) · [ACCEPTANCE.md](./clickhousex/ACCEPTANCE.md) · [tasks/](./clickhousex/tasks/) | ClickHouse — OLAP 查询、批量写入（v1.0.1 GitHub Release 已发布；v1.0.2 foundation 本地验收证据已记录，远端 v1.0.2 Release/CI 未闭合；完整客户端能力仍待 Exec/Query/InsertBatch/Rows 与 live ClickHouse 证据；BLK-003 open；非 factory）                                                                     |
