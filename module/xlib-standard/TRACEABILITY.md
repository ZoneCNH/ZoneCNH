...
| FR-002 | Error 标准 | AC-004: NewError 创建 Error 字段正确 | TC-004 | TASK-XLIB-006 | pending |
| FR-002 | Error 标准 | AC-005: WrapError 包装 errors.Is 可穿透 | TC-005 | TASK-XLIB-006 | pending |
| FR-002 | Error 标准 | AC-006: IsKind 匹配返回 true | TC-006 | TASK-XLIB-006 | pending |
| FR-002 | Error 标准 | AC-007: context.DeadlineExceeded ErrorKind = timeout | TC-007 | TASK-XLIB-006 | pending |
| FR-002 | Error 标准 | AC-008: closed error ErrorKind = closed | TC-008 | TASK-XLIB-006 | pending |
| FR-003 | Health 标准 | AC-009: HealthCheck nil context 返回 unhealthy | TC-009 | TASK-XLIB-007 | pending |
| FR-003 | Health 标准 | AC-010: HealthCheck 健康客户端返回 healthy | TC-010 | TASK-XLIB-007 | pending |
| FR-004 | Metrics 标准 | AC-011: NoopMetrics 不 panic | TC-011 | TASK-XLIB-007 | pending |
| FR-004 | Metrics 标准 | AC-012: 指标名匹配 contract 5 个 P0 指标名一致 | TC-012 | TASK-XLIB-007 | pending |
| FR-004 | Metrics 标准 | AC-013: label 低基数只有 op/kind/status | TC-013 | TASK-XLIB-007 | pending |
| FR-005 | Client 标准 | AC-014: New nil context 返回错误 | TC-014 | TASK-XLIB-006 | pending |
| FR-005 | Client 标准 | AC-015: New canceled context 返回错误 | TC-015 | TASK-XLIB-006 | pending |
| FR-005 | Client 标准 | AC-016: New 无效 config 返回错误 | TC-016 | TASK-XLIB-006 | pending |
| FR-005 | Client 标准 | AC-017: New 正常创建返回 *Client | TC-017 | TASK-XLIB-006 | pending |
| FR-005 | Client 标准 | AC-018: Close 幂等多次调用不 panic | TC-018 | TASK-XLIB-006 | pending |
| FR-006 | Version 标准 | AC-019: 版本信息返回 module path/version/commit/build time | N/A (API check) | TASK-XLIB-003 | pending |
| FR-007 | 公共 API 模板 | AC-020: 模板 go vet 零警告 | TC-019 | TASK-XLIB-008 | pending |
| FR-008 | 模板可编译 | AC-021: 模板 go test 全部通过 | TC-020 | TASK-XLIB-008 | pending |
...
| EVID-TEST-TASK-XLIB-003-001 | TASK-XLIB-003 | AC-001~AC-003, AC-019 | pending |
| EVID-TEST-TASK-XLIB-006-001 | TASK-XLIB-006 | AC-004~AC-008, AC-014~AC-018 | pending |
| EVID-TEST-TASK-XLIB-007-001 | TASK-XLIB-007 | AC-009~AC-013 | pending |
| EVID-TEST-TASK-XLIB-008-001 | TASK-XLIB-008 | AC-020, AC-021 | pending |
