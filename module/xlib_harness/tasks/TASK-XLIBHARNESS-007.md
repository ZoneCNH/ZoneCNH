...
spec_ref:
  - "module/xlib_harness/SPEC.md#NFR-005"
  - "module/xlib_harness/SPEC.md#AC-007"
acceptance_criteria:
...
files:
  - "/home/xlib_harness/FEATURES.md"
  - "/home/xlib_harness/ACCEPTANCE.md"
  - "/home/xlib_harness/.github/workflows/ci.yml"
  - "/home/xlib_harness/.github/workflows/release.yml"
priority: P1
status: completed
---
...
- [x] `/home/xlib_harness/FEATURES.md` 记录 v0.1.6 功能、覆盖率、CI/CD 与发布证据。
- [x] `/home/xlib_harness/ACCEPTANCE.md` 记录 v0.1.6 验收门禁、性能基线、覆盖率与总体评分。
...
- /home/xlib_harness@d90b35124701：tag `v0.1.6` 已发布；Release run `27855366871` PASS；main CI run `27855396013` PASS。
