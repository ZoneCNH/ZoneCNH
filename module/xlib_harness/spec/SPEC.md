...
> 公开投影说明：v0.1.6 已由 `/home/workspace/xlib_harness@d90b35124701` 的本地验收、GitHub Actions Release run `27855366871`、main CI run `27855396013` 和 GitHub Release 证据支撑。
...
Module implementation lives in `/home/workspace/xlib_harness`; this root repository only stores governance projection documents.
