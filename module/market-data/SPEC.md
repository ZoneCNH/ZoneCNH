...
- [ ] **Naming Mapping 验证**: 当前实现使用 string/interface{} 占位，尚未 import `domain-market` canonical 类型（ProductLine/InstrumentKey/MarketFactEnvelope）。待 domain-market Go 模块发布后引入。
