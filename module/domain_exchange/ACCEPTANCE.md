...
> 本文档是 domain_exchange 的 **完成定义（Definition of Done）**，把 SPEC 的 AC/TC 展开成可执行的验收项。
...
- [ ] **AC-EXC-001** FR-EXC-001
- [ ] **AC-EXC-002** FR-EXC-002
- [ ] **AC-EXC-003** FR-EXC-003
- [ ] **AC-EXC-004** FR-EXC-004
- [ ] **AC-EXC-005** FR-EXC-005
- [ ] **AC-EXC-006** FR-EXC-006
- [ ] **AC-EXC-007** FR-EXC-007
- [ ] **AC-EXC-008** FR-EXC-008
- [ ] **AC-EXC-009** FR-EXC-009
- [ ] **AC-EXC-010** FR-EXC-010
- [ ] **AC-EXC-011** FR-EXC-011
- [ ] **AC-EXC-012** FR-EXC-012
...
go test ./module/domain_exchange/... 2>/dev/null || true   # 远程仓库为准
