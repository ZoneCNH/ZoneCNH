#!/bin/bash
# =============================================================================
# xlib_standard 迁移脚本: xlib-standard → xlib_standard (kebab→snake_case)
#
# WARNING: xlib_standard is the ROOT of the dependency tree.
# 迁移后必须重新构建全域 24 模块。不要在生产环境/发布分支上运行。
# =============================================================================
set -euo pipefail
...
NEW_MODULE_PATH="github.com/xhyperium/xlib_standard"
OLD_NAME="xlib-standard"
NEW_NAME="xlib_standard"
...
if [ "$DRY_RUN" = "1" ]; then
    ...
    echo "[DRY_RUN] WARNING: This is the ROOT module — affects ALL 24 consumers"
    exit 0
fi

echo "========================================="
echo "  Migration: ${OLD_NAME} → ${NEW_NAME}"
echo "  CRITICAL: Root module — affects all 24 consumers"
echo "========================================="
...
# ---------------------------------------------------------------------------
echo "========================================="
echo "  Validation: ${MODULE} (ROOT MODULE)"
echo "========================================="
echo "--- go build ./... ---"
...
echo "  WARNING: ALL 24 consumers must rebuild after this step"
echo "========================================="
