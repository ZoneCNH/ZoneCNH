#!/bin/bash
# =============================================================================
# domain_market 迁移脚本: domain-market → domain_market (kebab→snake_case)
# =============================================================================
set -euo pipefail

MODULE="domain_market"
MODULE_DIR="/home/workspace/${MODULE}"
OLD_MODULE_PATH="github.com/xhyperium/domain-market"
NEW_MODULE_PATH="github.com/xhyperium/domain_market"
OLD_NAME="domain-market"
NEW_NAME="domain_market"
