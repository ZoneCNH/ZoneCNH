#!/bin/bash
# =============================================================================
# xlib_harness 迁移脚本: xlib-harness → xlib_harness (kebab→snake_case)
# =============================================================================
set -euo pipefail

MODULE="xlib_harness"
MODULE_DIR="/home/workspace/${MODULE}"
OLD_MODULE_PATH="github.com/xhyperium/xlib-harness"
NEW_MODULE_PATH="github.com/xhyperium/xlib_harness"
OLD_NAME="xlib-harness"
NEW_NAME="xlib_harness"
...
if [ "$CURRENT_BRANCH" != "main" ]; then
    if [ "${NON_INTERACTIVE:-0}" = "1" ]; then
        echo "WARNING: Current branch is '${CURRENT_BRANCH}', not 'main'. Proceeding (non-interactive)."
    else
