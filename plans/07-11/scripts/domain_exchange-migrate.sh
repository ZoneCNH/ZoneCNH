#!/bin/bash
# =============================================================================
# domain_exchange 迁移脚本: domain-exchange → domain_exchange (kebab→snake_case)
# =============================================================================
set -euo pipefail

MODULE="domain_exchange"
MODULE_DIR="/home/workspace/${MODULE}"
OLD_MODULE_PATH="github.com/xhyperium/domain-exchange"
NEW_MODULE_PATH="github.com/xhyperium/domain_exchange"
OLD_NAME="domain-exchange"
NEW_NAME="domain_exchange"
