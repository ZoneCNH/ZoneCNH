#!/usr/bin/env bash
# Create remaining GitHub issues for Plan 008, resuming from a given index
# Usage: bash 008-create-gh-issues-resume.sh <start_index_0based>
set -euo pipefail
...
echo "Resuming from index $START, creating issues $((START+1)) to $COUNT..."
...
echo ""
echo "=== Done. Map at $MAP ==="
echo "Total map entries: $(($(wc -l < "$MAP") - 1))"
