...
**目标：** 闭合两份复核报告发现的全部缺口——Report1（生产就绪）的 G1~G6 / R1~R8 与 Report2（解耦架构）的 §7.1~§7.7——使 `module/binance` 达到「可发布、可验证」的生产级别，并消除跨仓库潜伏工程炸弹（transportx module name bug / domain\_\* path 分叉）。
...
| B2   | domain\_\* module path 下划线 vs 连字符分叉                                  | **高** | Report2 §7.2  |
...
| B2  | domain\_\* module path 统一为 snake_case |   高   | B3       |   2   |
...
| A6   | §6.1 R6 / §7.2                    | —            |   P1   |   6   | ✅ DONE (2026-06-25: 24 benchmarks PASS) |
| A7   | §3.3 FR-030 / §7.2 R8             | —            |   P1   |   4   | ✅ DONE (2026-06-24) |
| A8   | §5 G6 / §7.3 R7 / §13             | —            |   P2   |   7   | ✅ DONE (2026-06-24) |
| A9   | §4.1 §12.10/12.11 / §7.3          | —            |   P2   |   7   | ✅ DONE (2026-06-25: bar 7 intervals + depth 4 update_id 核实) |
| A10  | §3.3 FR-024                       | —            |   P2   |   7   | ✅ DONE (2026-06-25: symbol reload ✅, 全量延后 P2) |
| B1   | —                                 | §7.1         |   高   |   2   | ✅ DONE (2026-06-24) |
| B2   | —                                 | §7.2         |   高   |   2   | ✅ DONE (2026-06-24: worktree/main 侧; binance 待 domain 重新发布) |
| B3   | —                                 | §7.3         |   中   |   2   | ✅ DONE (2026-06-24) |
| B4   | —                                 | §7.4         |   中   |   5   | ✅ DONE (2026-06-25) |
| B5   | —                                 | §7.5         |   中   |   5   | ✅ DONE (2026-06-25: 过渡态文档化) |
| B6   | —                                 | §7.6         |   低   |   7   | ✅ DONE (2026-06-25) |
| B7   | —                                 | §7.7         |   低   |   7   | ✅ DONE (2026-06-25) |
| B8   | —                                 | §6 / §8      |   低   |   7   | ✅ DONE (2026-06-25) |
...
>
> 双轨可并行：Track A（binance runtime + module/binance 规格）与 Track B（跨仓库 transportx/domain\_\*）由不同工程师推进，Phase 8 汇合验收。
