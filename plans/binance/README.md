...
| 008 | binance 生产修复总计划（40 Task，5 Phase；Beads/GitHub #1132-#1171） | P0/P1/P2 | XL | Plan007 DONE | 🟡 LOCAL DONE / RELEASE-GATED（2026-06-25） — T008.001-T008.038 本地/CI 闭合；runtime PR #145 @ `d8668243cab999549bedfb60b7ffc8781f7190f2`；foundation PRs taosx#18/natsx#19/kafkax#20/clickhousex#11；10 轮一致性 + 7 轮忠实性验证 PASS；T008.039/T008.040 因 live/release/chaos/SLO 外部门禁保持 open。详见 [008-binance-production-fix-master-plan.md](008-binance-production-fix-master-plan.md) · [008-issues-sync-report.md](008-issues-sync-report.md) |
...
- 2026-06-25: [Plan008 同步报告](008-issues-sync-report.md) 登记 40 Task 三方映射、runtime PR #145、foundation PRs 和 10 轮核验；本地/CI 可闭合 T008.001-T008.038，不改变 release_closeable=NO 口径。
