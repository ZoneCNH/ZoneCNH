...
| 013 | binance 白名单规则统一重构（禁止向后兼容：7 套机制收敛为 1 套；新 tier 词表 prime/standard/lite/blocked；PG 双表 SSOT + tierCapabilityMap 代码映射；接通 DepthLevel 全链路；6 Phase） | P0/P1 | L | PR #1742 报告 | 📋 **TODO** — 计划文档已落盘，待 Phase 0 审批后启动。决策基线：重新设计词表 / PG 双表 SSOT / 接通 DepthLevel / tier 单列推导。详见 [013-whitelist-unification-plan-20260709.md](013-whitelist-unification-plan-20260709.md) · 输入 [report/binance/WHITELIST-LOGIC-ANALYSIS-20260709.md](../../report/binance/WHITELIST-LOGIC-ANALYSIS-20260709.md)（PR #1742） |
