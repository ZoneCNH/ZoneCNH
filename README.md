...
- [postgresx](https://github.com/ZoneCNH/postgresx) — PostgreSQL — 关系型存储、事务、迁移（v0.1.0 candidate，SPEC + TRACEABILITY + goal + tasks 就绪） `公开`
...
- [kafkax](https://github.com/ZoneCNH/kafkax) — Kafka — 消息队列、事件流（[v1.0.0](https://github.com/ZoneCNH/kafkax/releases/tag/v1.0.0) 已发布：[PR #5](https://github.com/ZoneCNH/kafkax/pull/5) 已合入，tag 指向 `0545db2`；真实 broker gates、release-check 与 score 10/10 已验证） `公开`
